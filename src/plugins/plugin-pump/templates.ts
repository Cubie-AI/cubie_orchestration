...
export function generateBuyTemplate(contextChain: BaseContextItem[]): string {
  return `
    Generate a buy template for the users request by extracting out a token mint address and the amount of tokens to buy. Your response should be a JSON object with 2 fields, mint and token amount.
