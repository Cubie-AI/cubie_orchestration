...
export function generateAddressInfoTemplate(
  ...
  return `
    Generate a query by extracting the address from the user request. Your response should be a JSON object with a single "adress" field containing your response.
    The response should be related to the original message you received from the user. 
